...
//    }
    ...
    @Test
    public void booksToString_shouldIncludeAuthorAndDate(){
    ...
    @Test
    public void menuString_shouldProduceMenu() {
        Library lib = new Library();
        String expectedMenu = "0 List of Books";
        String result = lib.menuString();
